...
DOCKER_IMAGE_NAME="docker.local:5000/jenkins/slave:${DOCKER_IMAGE_VERSION}"
DOCKER_VOLUMES="-v /var/run/docker.sock:/var/run/docker.sock -v /srv/config:/srv/config:ro -v /srv/hudson:/srv/hudson:ro -v /var/lib/hudson/.m2:/var/lib/hudson/.m2:ro"
