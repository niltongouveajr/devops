...
def call() {
    ...
    Message = "A new release <b>${TagName}</b> has been generated.<br>The new release can be found <a href=\"${env.BUILD_URL}console\">[here]</a> and manual tests can be performed."
    if (isUnix()) {
